document.addEventListener("DOMContentLoaded", () => {
  ...
  socket.on("gameWindowSeting", (Data) => {
  ...
  socket.on("statisticGame", (stat) => {
    //all draw game coin , player
  ...
  function updatePosition() {
    //check moving if moving send to server key to calculate your position
  ...
  document.addEventListener("blur", (event) => {
    //force stop moving change window
